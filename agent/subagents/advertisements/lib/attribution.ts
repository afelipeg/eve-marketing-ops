 ...
 *
 * NOTE ON OWNERSHIP: this is the planning-time copy used to allocate spend
 * across publishers and placements. The measurement agent owns the canonical
 * read and the significance verdict; when the two disagree, measurement wins.
 * Never present these shares as a validated measurement.
 *
