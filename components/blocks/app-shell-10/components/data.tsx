...
import { BotIcon, MessageSquareIcon, WrenchIcon, DatabaseIcon, PlayIcon, BarChart3Icon, SettingsIcon, ExternalLinkIcon, UserPlusIcon, FlagIcon, CopyIcon, ArchiveIcon } from "lucide-react"
...
export const NAV_MAIN: NavItem[] = [
  {
    ...
    children: [
      { id: "my-agents", label: "My Agents", isActive: false },
