...
export function AuthLogo({ className }: { className?: string }) {
  return (
    <div className={cn("flex items-center gap-2.5", className)}>
      <Item
        className="bg-primary text-primary-foreground flex size-9 shrink-0 items-center justify-center p-0"
        aria-hidden="true"
      >
      ...
      <span className="text-base font-semibold tracking-tight">Marketing Ops</span>
    </div>
  )
}
